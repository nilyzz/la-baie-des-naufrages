const CACHE_NAME = 'baie-des-naufrages-v1-85';
const PRECACHE_URLS = [
    '/',
    '/index.html',
    ...
    '/ads.txt',
    '/style.min.css?v=v1-85',
    '/script.min.js?v=v1-85',
    '/js/main.bundle.min.js?v=v1-85',
    '/js/core/consent.js?v=v1-85',
    '/js/core/sw-register.js?v=v1-85',
    '/site.webmanifest',
