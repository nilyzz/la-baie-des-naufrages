const CACHE_NAME = 'baie-des-naufrages-v2-30';
const PRECACHE_URLS = [
    '/',
    '/index.html',
    ...
    '/ads.txt',
    '/style.min.css?v=v2-30',
    '/js/main.bundle.min.js?v=v2-30',
    '/js/core/consent.js?v=v2-30',
    '/js/core/sw-register.js?v=v2-30',
    '/site.webmanifest',
    ...
    '/js/chunks/chunk-VOAPVLOB.js',
    '/js/chunks/chunk-W4TJQMPG.js',
    '/js/chunks/chunk-ZQH3MLCO.js',
    '/js/chunks/cinema-L2HPFVZV.js',
    '/js/chunks/game-event-bindings-Q5FSQVE2.js',
    '/js/chunks/game-lifecycle-45Y7C2IT.js',
