const CACHE_NAME = 'baie-des-naufrages-v2-63';
const PRECACHE_URLS = [
    '/',
    '/index.html',
    ...
    '/ads.txt',
    '/style.min.css?v=v2-63',
    '/js/main.bundle.min.js?v=v2-63',
    '/js/core/consent.js?v=v2-63',
    '/js/core/sw-register.js?v=v2-63',
    '/site.webmanifest',
