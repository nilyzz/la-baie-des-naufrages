const CACHE_NAME = 'baie-des-naufrages-v1-98';
const PRECACHE_URLS = [
    '/',
    '/index.html',
    ...
    '/ads.txt',
    '/style.min.css?v=v1-98',
    '/script.min.js?v=v1-98',
    '/js/main.bundle.min.js?v=v1-98',
    '/js/core/consent.js?v=v1-98',
    '/js/core/sw-register.js?v=v1-98',
    '/site.webmanifest',
