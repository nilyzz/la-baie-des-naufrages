const CACHE_NAME = 'baie-des-naufrages-v1-83';
const PRECACHE_URLS = [
    '/',
    '/index.html',
    ...
    '/ads.txt',
    '/style.min.css?v=v1-83',
    '/script.min.js?v=v1-83',
    '/js/main.bundle.min.js?v=v1-83',
    '/js/core/consent.js?v=v1-83',
    '/js/core/sw-register.js?v=v1-83',
    '/site.webmanifest',
