const CACHE_NAME = 'baie-des-naufrages-v2-39';
const PRECACHE_URLS = [
    '/',
    '/index.html',
    ...
    '/ads.txt',
    '/style.min.css?v=v2-39',
    '/js/main.bundle.min.js?v=v2-39',
    '/js/core/consent.js?v=v2-39',
    '/js/core/sw-register.js?v=v2-39',
    '/site.webmanifest',
    ...
    // CHUNKS_START
    '/js/chunks/chunk-3ORBDJ7D.js',
    '/js/chunks/chunk-LBCV6VXI.js',
    ...
    '/js/chunks/game-event-bindings-RZ4VEUJG.js',
    '/js/chunks/game-lifecycle-PT3F2S4Q.js',
