const CACHE_NAME = 'baie-des-naufrages-v2-62';
const PRECACHE_URLS = [
    '/',
    '/index.html',
    ...
    '/ads.txt',
    '/style.min.css?v=v2-62',
    '/js/main.bundle.min.js?v=v2-62',
    '/js/core/consent.js?v=v2-62',
    '/js/core/sw-register.js?v=v2-62',
    '/site.webmanifest',
