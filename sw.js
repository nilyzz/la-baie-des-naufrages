const CACHE_NAME = 'baie-des-naufrages-v0-273';
const PRECACHE_URLS = [
    '/',
    '/index.html',
    ...
    '/ads.txt',
    '/style.min.css?v=v2-67',
    '/js/main.bundle.min.js?v=v2-67',
    '/js/core/consent.js?v=v2-67',
    '/js/core/sw-register.js?v=v2-67',
    '/site.webmanifest',
    ...
    '/js/chunks/chunk-KKNST62H.js',
    '/js/chunks/chunk-KMAVLF6Q.js',
    '/js/chunks/chunk-V2AZNKNT.js',
    '/js/chunks/chunk-VC46IEJQ.js',
    '/js/chunks/chunk-W4TJQMPG.js',
    '/js/chunks/cinema-PBMNF7JY.js',
    '/js/chunks/game-event-bindings-6CGLCYRX.js',
    '/js/chunks/game-lifecycle-TQVHAJRU.js',
