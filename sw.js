const CACHE_NAME = 'baie-des-naufrages-v1-82';
const PRECACHE_URLS = [
    '/',
    '/index.html',
    ...
    '/ads.txt',
    '/style.min.css?v=v1-82',
    '/script.min.js?v=v1-82',
    '/js/main.bundle.min.js?v=v1-82',
    '/js/core/consent.js?v=v1-82',
    '/js/core/sw-register.js?v=v1-82',
    '/site.webmanifest',
