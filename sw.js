const CACHE_NAME = 'baie-des-naufrages-v2-25';
const PRECACHE_URLS = [
    '/',
    '/index.html',
    ...
    '/ads.txt',
    '/style-core.min.css?v=v2-25',
    '/style-games.min.css?v=v2-25',
    '/js/main.bundle.min.js?v=v2-25',
    '/js/core/consent.js?v=v2-25',
    '/js/core/sw-register.js?v=v2-25',
    '/site.webmanifest',
