const CACHE_NAME = 'baie-des-naufrages-v2-38';
const PRECACHE_URLS = [
    '/',
    '/index.html',
    ...
    '/ads.txt',
    '/style.min.css?v=v2-38',
    '/js/main.bundle.min.js?v=v2-38',
    '/js/core/consent.js?v=v2-38',
    '/js/core/sw-register.js?v=v2-38',
    '/site.webmanifest',
    ...
    // CHUNKS_START
    '/js/chunks/chunk-2UVRJXE2.js',
    '/js/chunks/chunk-UHJ5DXJJ.js',
    '/js/chunks/chunk-V2AZNKNT.js',
    '/js/chunks/chunk-VC46IEJQ.js',
    '/js/chunks/chunk-W4TJQMPG.js',
    '/js/chunks/chunk-ZQH3MLCO.js',
    '/js/chunks/cinema-2QDUX3AQ.js',
    '/js/chunks/game-event-bindings-DYYDQE65.js',
    '/js/chunks/game-lifecycle-P3PUCBO3.js',
