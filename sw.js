const CACHE_NAME = 'baie-des-naufrages-v1-87';
const PRECACHE_URLS = [
    '/',
    '/index.html',
    ...
    '/ads.txt',
    '/style.min.css?v=v1-87',
    '/script.min.js?v=v1-87',
    '/js/main.bundle.min.js?v=v1-87',
    '/js/core/consent.js?v=v1-87',
    '/js/core/sw-register.js?v=v1-87',
    '/site.webmanifest',
