const CACHE_NAME = 'baie-des-naufrages-v2-02';
const PRECACHE_URLS = [
    '/',
    '/index.html',
    ...
    '/ads.txt',
    '/style.min.css?v=v2-02',
    '/script.min.js?v=v2-02',
    '/js/main.bundle.min.js?v=v2-02',
    '/js/core/consent.js?v=v2-02',
    '/js/core/sw-register.js?v=v2-02',
    '/site.webmanifest',
