const CACHE_NAME = 'baie-des-naufrages-v2-43';
const PRECACHE_URLS = [
    '/',
    '/index.html',
    ...
    '/ads.txt',
    '/style.min.css?v=v2-43',
    '/js/main.bundle.min.js?v=v2-43',
    '/js/core/consent.js?v=v2-43',
    '/js/core/sw-register.js?v=v2-43',
    '/site.webmanifest',
    ...
    '/js/chunks/chunk-KZEPVCST.js',
    '/js/chunks/chunk-NWRSJ5EY.js',
    '/js/chunks/chunk-V2AZNKNT.js',
    '/js/chunks/chunk-VC46IEJQ.js',
    '/js/chunks/chunk-W4TJQMPG.js',
    '/js/chunks/cinema-PBMNF7JY.js',
    '/js/chunks/game-event-bindings-DHPL37XQ.js',
    '/js/chunks/game-lifecycle-H2VPGQST.js',
