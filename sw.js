const CACHE_NAME = 'baie-des-naufrages-v1-88';
const PRECACHE_URLS = [
    '/',
    '/index.html',
    ...
    '/ads.txt',
    '/style.min.css?v=v1-88',
    '/script.min.js?v=v1-88',
    '/js/main.bundle.min.js?v=v1-88',
    '/js/core/consent.js?v=v1-88',
    '/js/core/sw-register.js?v=v1-88',
    '/site.webmanifest',
