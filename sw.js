const CACHE_NAME = 'baie-des-naufrages-v2-03';
const PRECACHE_URLS = [
    '/',
    '/index.html',
    ...
    '/ads.txt',
    '/style.min.css?v=v2-03',
    '/script.min.js?v=v2-03',
    '/js/main.bundle.min.js?v=v2-03',
    '/js/core/consent.js?v=v2-03',
    '/js/core/sw-register.js?v=v2-03',
    '/site.webmanifest',
