const CACHE_NAME = 'baie-des-naufrages-v2-00';
const PRECACHE_URLS = [
    '/',
    '/index.html',
    ...
    '/ads.txt',
    '/style.min.css?v=v2-00',
    '/script.min.js?v=v2-00',
    '/js/main.bundle.min.js?v=v2-00',
    '/js/core/consent.js?v=v2-00',
    '/js/core/sw-register.js?v=v2-00',
    '/site.webmanifest',
