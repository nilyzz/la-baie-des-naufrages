const CACHE_NAME = 'baie-des-naufrages-v1-74';
const PRECACHE_URLS = [
    '/',
    '/index.html',
    ...
    '/ads.txt',
    '/style.min.css?v=v1-74',
    '/script.min.js?v=v1-74',
    '/js/main.bundle.min.js?v=v1-74',
    '/js/core/consent.js?v=v1-74',
    '/js/core/sw-register.js?v=v1-74',
    '/site.webmanifest',
